...
<section className="bg-white py-16 px-4 sm:px-8">
  <div className="max-w-5xl mx-auto text-center">
    ...
    <p className="text-gray-600 mb-10">
      Kindred helps young people connect with real-world clubs, events, and safe spaces tailored to who they are.
    </p>
    ...
    <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="p-6 rounded-2xl shadow-md bg-gray-50 flex flex-col justify-center items-center">
        ...
        <p className="text-gray-600 text-sm">Group chats help you connect with others and ease social anxiety.</p>
      </div>
      ...
      <div className="p-6 rounded-2xl shadow-md bg-gray-50">
        ...
        <p className="text-gray-600 text-sm">Celebrate your milestones and encourage trying new things.</p>
      </div>
