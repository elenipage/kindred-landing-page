  ...
  <div className="max-w-5xl mx-auto text-center">
    ...
    <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
      <div className="p-6 rounded-2xl shadow-md bg-gray-50 flex flex-col justify-center items-center">
        <img className="w-15 mb-3" src="/assets/locationPin.png"/>
      ...
      <div className="p-6 rounded-2xl shadow-md bg-gray-50 flex flex-col justify-center items-center">
        <img className="w-15 mb-3" src="/assets/chatBubble.png"/>
      ...
      <div className="p-6 rounded-2xl shadow-md bg-gray-50 flex flex-col justify-center items-center">
        <img className="w-15 mb-3" src="/assets/tagIcon.png"/>
      ...
      <div className="p-6 rounded-2xl shadow-md bg-gray-50 flex flex-col justify-center items-center">
        <img className="w-15 mb-3" src="/assets/starIcon.png"/>
      ...
      <div className="p-6 rounded-2xl shadow-md bg-gray-50 flex flex-col justify-center items-center">
        <img className="w-15 mb-3" src="/assets/secureIcon.png"/>
      ...
      <div className="p-6 rounded-2xl shadow-md bg-gray-50 flex flex-col justify-center items-center">
        <img className="w-15 mb-3" src="/assets/brainIcon.png"/>
